...
const Referals = () => (
    <div className={style.referals}>
        ...
        <ReactWOW animation="fadeInUp" delay="0.05s">
            ...
            Условия AirDrop и реферальной <br /> программы токена CNG
            </h3>
            <p className={style.referals__subTitle}>
            Registration by ref link - <span>$ 300</span> in CNG
            </p>
        </ReactWOW>
        <div className={style.referals__tableWrapper}>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.referals__tableWrapper_item}>
                    ...
                    <p className={style.referals__tableWrapper_currency}>sin CNG</p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.referals__tableWrapper_item}>
                    ...
                    <p className={style.referals__tableWrapper_price}>$ 100</p>
                    <p className={style.referals__tableWrapper_currency}>sin CNG</p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
