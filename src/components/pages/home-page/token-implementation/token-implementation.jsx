...
const TokenImplementation = () => (
    <div className={style.tokenImplementation}>
        ...
        <ReactWOW animation="fadeInUp" delay="0.05s">
            <h3 className={style.tokenImplementation__title}>Реализация токена CNG</h3>
        </ReactWOW>
        <div className={style.tokenImplementation__contentWrapper}>
            ...
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.tokenImplementation__contentWrapper_item}>
                    ...
                    <p className={style.tokenImplementation__contentWrapper_subTitle}>
                        Реализация токена через реферальную программу и AirDrop на бирже
                        Coinsbit.
                    </p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.tokenImplementation__contentWrapper_item}>
                    ...
                    <p className={style.tokenImplementation__contentWrapper_subTitle}>
                        Подготовка к открытию торгов и начисление токенов.
                    </p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.tokenImplementation__contentWrapper_item}>
                    ...
                    <p className={style.tokenImplementation__contentWrapper_subTitle}>
                        Запуск торгов по токену CNG на бирже Coinsbit.
                    </p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.tokenImplementation__contentWrapper_item}>
                    ...
                    <p className={style.tokenImplementation__contentWrapper_subTitle}>
                        Интеграция токена на CNGame Casino и подготовка к запуску
                        платформы.
                    </p>
                </div>
            </ReactWOW>
            <ReactWOW animation="fadeInUp" delay="0.05s">
                <div className={style.tokenImplementation__contentWrapper_item}>
                    ...
                    <p className={style.tokenImplementation__contentWrapper_subTitle}>
                        Запуск и открытие CNGame Casino.
                    </p>
                </div>
            </ReactWOW>
        </div>
